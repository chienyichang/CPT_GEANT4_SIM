...
class LXeUserEventInformation : public G4VUserEventInformation
{
  public:
    ...
    void SetEventTime(const G4double f) { fTime = f; }
    inline G4double GetEventTime() const { return fTime; }

    void SetMuonEnergy(const G4double f) { fMuEnergy = f; }
    inline G4double GetMuonEnergy() const { return fMuEnergy; }
