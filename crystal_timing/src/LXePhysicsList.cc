...
void LXePhysicsList::ConstructBosons()
{
    // pseudo-particles
...
void LXePhysicsList::ConstructLeptons()
{
    // leptons
    //  e+/-
...
void LXePhysicsList::ConstructMesons()
{
    //  mesons
...
void LXePhysicsList::ConstructBaryons()
{
    //  barions
...
void LXePhysicsList::ConstructGeneral()
{
    // Add Decay Process
...
void LXePhysicsList::ConstructOp()
{
...
void LXePhysicsList::SetVerbose (G4int verbose)
{
...
void LXePhysicsList::SetNbOfPhotonsCerenkov (G4int MaxNumber)
{
...
void LXePhysicsList::SetCutForGamma (G4double cut)
{
    cutForGamma = cut;
...
void LXePhysicsList::SetCutForElectron (G4double cut)
{
    cutForElectron = cut;
...
void LXePhysicsList::SetCutForPositron (G4double cut)
{
    cutForPositron = cut;
...
void LXePhysicsList::SetCutForProton (G4double cut)
{
    cutForPositron = cut;
